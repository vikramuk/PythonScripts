...
caps.setCapability("app","sauce-storage:ApiDemos-debug. apk"); 
	...
	driver = new AndroidDriver(new URL("http:// <<SauceLabs_ UserName>>:<<SauceLabs_accessID>> @ondemand.saucelabs.com:80/wd/hub"), caps); 
	//initializing  waits 
	...
	driver.findElement(MobileBy.AccessibilityId("Accessibil ity")).click(); 
